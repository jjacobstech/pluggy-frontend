<template>
      ...
      <div className="min-h-screen bg-gradient-hero flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                  ...
                  <div className="bg-card rounded-3xl shadow-[var(--shadow-elegant)] p-8 md:p-10 border border-border">
                        <!-- {/* Logo */} -->
                        ...
                        <div className="space-y-5">
                              <div class="space-y-2 flex items-center gap-9 ">
                                    <label class="bg-red-orange bg-clip-text text-transparent text-nowrap"
                                          htmlFor="name">Full
                                          Name</label>
                                    <input id="name" v-model="form.name" type="text" placeholder="John Doe" value=""
                                          @change="" required
                              ...
                              <div class="space-y-2 flex items-center gap-10 ">
                                    ...
                                    <input id="password" v-model="form.password" type="password"
                                          placeholder=".........." value="" @change="" required
                                          class="h-10 placeholder:text-white text-white rounded-lg pl-2 bg-red-orange " />
                              </div>
                              <div class="space-y-2 flex items-center gap-9  ">
                                    <label class="bg-red-orange bg-clip-text text-transparent text-wrap "
                                          htmlFor="confirm_password">Confirm
                                          <br />
                                          Password</label>
...
const register = () => {
      ...
      if (!input.success) {
            ...
            if (error.name) {
                  ...
                  notify.show(error.confirm_password[0] ? "Choose a longer password" : "Confirm password cannot be empty");
                  notify.timeout(2000);
      ...
      const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsIm5hbWUiOiJKb3NodWEiLCJpYXQiOjE3MzA2OTE3NzcsImV4cCI6MTczMDcwNTM3N30.c0deEXAMPLEsigNaTure987654321"
