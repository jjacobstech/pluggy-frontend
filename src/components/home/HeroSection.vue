      ...
      <section class="container mx-auto px-4 py-20 md:py-32">
            <div class="max-w-4xl mx-auto text-center animate-slide-up">
                  ...
                  <p class="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
                        Pluggy.io is your all-in-one solution for managing links and viewing PDFs.
                  ...
                  <div class="max-w-2xl mx-auto mb-12">
                        ...
                        <p class="text-xl py-5 bg-red-orange bg-clip-text text-transparent
                              transition-all duration-450">
                              {{ link }}
                        </p>
                        <p class="text-sm text-muted-foreground mt-3">
                              No signup required for basic features.
                              <Link to="/register" class="text-primary hover:underline">Create an account
